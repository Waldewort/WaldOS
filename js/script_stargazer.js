    ...
    geoBtn.addEventListener("click", () => {
      ...
      if (savedLocation) {
        try {
          ...
          const city = coords.city || "Current Location";
          ...
          console.warn("Fehler beim Lesen des gespeicherten Standorts:", e);
          alert("Der gespeicherte Standort konnte nicht verarbeitet werden.");
        }
      } else {
        alert("Kein gespeicherter Standort gefunden. Bitte führen Sie zuerst die Standortabfrage aus.");
      }
    });
  }
...
    raycaster.params.Line.threshold = 22; 
